...
// vi.hoisted ensures mockStripe is available when vi.mock factory runs (vitest hoists vi.mock calls)
...
describe("POST /api/webhooks/stripe", () => {
  ...
  it("processes customer.subscription.deleted — uses metadata school_id, sets status to canceled", async () => {
    ...
    mockStripe.webhooks.constructEvent.mockReturnValue(deletedEvent as never);
